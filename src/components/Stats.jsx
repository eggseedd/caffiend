...
export default function Stats() {
    ...
    const warningLevel = caffeineLevel < statusLevels['low'].maxLevel ? 
        'low' : caffeineLevel < statusLevels['high'].maxLevel ? 'moderate' : 'high'
            ...
            <div className="stats-grid">
                <StatCard lg title="Active Caffeine Level">
                    <div className="status">
                        ...
                        <h5 style={{color: statusLevels[warningLevel].color, background: statusLevels[warningLevel].background }}>{warningLevel.charAt(0).toUpperCase() + warningLevel.slice(1)}</h5>
                    </div>
